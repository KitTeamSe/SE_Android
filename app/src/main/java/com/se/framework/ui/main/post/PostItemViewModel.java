...
public class PostItemViewModel {
    ...
    private final PostResponse.Data.PostListItem.Post mPost;

    public final PostItemViewModelListener mListener;

    public PostItemViewModel(PostResponse.Data.PostListItem.Post post, PostItemViewModelListener listener){
        this.mPost = post;
    ...
    public interface PostItemViewModelListener {
        void onItemClick(PostResponse.Data.PostListItem.Post post);
    }
}
